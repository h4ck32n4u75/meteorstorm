**Multiple Environment Threat Evaluation of Resources Space Threats and Operational Risk to Missions (METEORSTORM) Threat Intelligence Tagging Guide**

**Audience:** watch floor analysts, duty officers, fusion cell leads, ISAC/ISAO participants, space mission cyber operators

**Purpose:** provide a structured reference and operational guide to understanding, fusing, and sharing threat intelligence using METEORSTORM and MISP taxonomies.
